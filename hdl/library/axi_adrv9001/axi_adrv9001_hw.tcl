...
ad_ip_files axi_adrv9001 [list\
  ...
  "intel/adrv9001_rx.v" \
  "intel/adrv9001_tx.v" \
  "intel/adrv9001_gpio_in.v" \
  "intel/adrv9001_gpio_out.v" \
  "adrv9001_pack.v" \
  "adrv9001_aligner4.v" \
  "adrv9001_aligner8.v" \
  "adrv9001_rx_link.v" \
...
#  set_instance_parameter_value periphery_clk_buf {DEVICE_FAMILY} {Arria 10}
  set_instance_parameter_value periphery_clk_buf {DEVICE_FAMILY} {Cyclone V}
  ...
  if {$m_cmos_lvds_n == 1} {
    add_interface_port device_if rx1_dclk_in_n_NC          rx1_dclk_in_n_NC          Input 1
    ...
    add_interface_port device_if rx1_strobe_in_n_NC        rx1_strobe_in_n_NC        Input 1
    ...
    add_interface_port device_if rx2_dclk_in_n_NC          rx2_dclk_in_n_NC          Input 1
    ...
    add_interface_port device_if rx2_strobe_in_n_NC        rx2_strobe_in_n_NC        Input 1
    ...
    add_interface_port device_if tx1_dclk_out_n_NC           tx1_dclk_out_n_NC           Output 1
    add_interface_port device_if tx1_dclk_out_p_dclk_out     tx1_dclk_out_p_dclk_out     Output 1
    add_interface_port device_if tx1_dclk_in_n_NC            tx1_dclk_in_n_NC            Input 1
    ...
    add_interface_port device_if tx1_strobe_out_n_NC         tx1_strobe_out_n_NC         Input 1
    ...
    add_interface_port device_if tx2_dclk_out_n_NC           tx2_dclk_out_n_NC           Output 1
    add_interface_port device_if tx2_dclk_out_p_dclk_out     tx2_dclk_out_p_dclk_out     Output 1
    add_interface_port device_if tx2_dclk_in_n_NC            tx2_dclk_in_n_NC            Input 1
    ...
    add_interface_port device_if tx2_strobe_out_n_NC         tx2_strobe_out_n_NC         Input 1
