...
module system_top (
  ...
  wire              tx1_dclk_out_p_i;
  wire              tx1_dclk_out_n_i;
  wire              tx1_idata_out_n_i;
  wire              tx1_idata_out_p_i;
  wire              tx1_qdata_out_n_i;
  wire              tx1_qdata_out_p_i;
  wire              tx1_strobe_out_p_i;
  wire              tx1_strobe_out_n_i;
     
  wire              tx2_dclk_out_p_i;
  wire              tx2_dclk_out_n_i;
  wire              tx2_idata_out_n_i;
  wire              tx2_idata_out_p_i;
  wire              tx2_qdata_out_n_i;
  wire              tx2_qdata_out_p_i;
  wire              tx2_strobe_out_p_i;
  wire              tx2_strobe_out_n_i;
  ...
  // defaults
  assign vccio_err = ~vccio_is_25;
  assign tx1_dclk_out_n   = (~vccio_is_25) ? tx1_dclk_out_n_i   : 1'bz;
  assign tx1_dclk_out_p   = (~vccio_is_25) ? tx1_dclk_out_p_i   : 1'bz;
  assign tx1_idata_out_n  = (~vccio_is_25) ? tx1_idata_out_n_i  : 1'bz;
  assign tx1_idata_out_p  = (~vccio_is_25) ? tx1_idata_out_p_i  : 1'bz;
  assign tx1_qdata_out_n  = (~vccio_is_25) ? tx1_qdata_out_n_i  : 1'bz;
  assign tx1_qdata_out_p  = (~vccio_is_25) ? tx1_qdata_out_p_i  : 1'bz;
  assign tx1_strobe_out_n = (~vccio_is_25) ? tx1_strobe_out_n_i : 1'bz;
  assign tx1_strobe_out_p = (~vccio_is_25) ? tx1_strobe_out_p_i : 1'bz;
  
  assign tx2_dclk_out_n   = (~vccio_is_25) ? tx2_dclk_out_n_i   : 1'bz;
  assign tx2_dclk_out_p   = (~vccio_is_25) ? tx2_dclk_out_p_i   : 1'bz;
  assign tx2_idata_out_n  = (~vccio_is_25) ? tx2_idata_out_n_i  : 1'bz;
  assign tx2_idata_out_p  = (~vccio_is_25) ? tx2_idata_out_p_i  : 1'bz;
  assign tx2_qdata_out_n  = (~vccio_is_25) ? tx2_qdata_out_n_i  : 1'bz;
  assign tx2_qdata_out_p  = (~vccio_is_25) ? tx2_qdata_out_p_i  : 1'bz;
  assign tx2_strobe_out_n = (~vccio_is_25) ? tx2_strobe_out_n_i : 1'bz;
  assign tx2_strobe_out_p = (~vccio_is_25) ? tx2_strobe_out_p_i : 1'bz;
  ...
  system_bd i_system_bd (
    ...
    .adrv9001_if_tx1_dclk_out_p_dclk_out (tx1_dclk_out_p_i),
    .adrv9001_if_tx1_dclk_in_p_dclk_in (tx1_dclk_in_p),
    .adrv9001_if_tx1_idata_out_n_idata0 (tx1_idata_out_n_i),
    .adrv9001_if_tx1_idata_out_p_idata1 (tx1_idata_out_p_i),
    .adrv9001_if_tx1_qdata_out_n_qdata2 (tx1_qdata_out_n_i),
    .adrv9001_if_tx1_qdata_out_p_qdata3 (tx1_qdata_out_p_i),
    .adrv9001_if_tx1_strobe_out_p_strobe_out (tx1_strobe_out_p_i),
    .adrv9001_if_tx2_dclk_out_p_dclk_out (tx2_dclk_out_p_i),
    .adrv9001_if_tx2_dclk_in_p_dclk_in (tx2_dclk_in_p),
    .adrv9001_if_tx2_idata_out_n_idata0 (tx2_idata_out_n_i),
    .adrv9001_if_tx2_idata_out_p_idata1 (tx2_idata_out_p_i),
    .adrv9001_if_tx2_qdata_out_n_qdata2 (tx2_qdata_out_n_i),
    .adrv9001_if_tx2_qdata_out_p_qdata3 (tx2_qdata_out_p_i),
    .adrv9001_if_tx2_strobe_out_p_strobe_out (tx2_strobe_out_p_i),
